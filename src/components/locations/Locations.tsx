...
const LOCATIONS = [
  {
    ...
    hours: 'Mon–Thu: 8am–11pm · Fri–Sun: 8am–11:30pm · Breakfast: 8–11am',
  ...
  },
  {
    ...
    hours: 'Mon–Sun: 8am–11pm · Breakfast: 8–11am',
    phone: '+91 72929 44244',
    ctaLabel: 'Get Directions →',
            ...
            >
              ...
              <div className="relative h-[280px] overflow-hidden">
                <img
                  src={loc.image}
                  alt={loc.name}
                  className={`w-full h-full object-cover${loc.badge === 'Flagship' ? ' scale-110' : ''}`}
                />
