...
const MENU_DATA: CategoryData[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Cranberry Cinnamon Cold Brew',   description: 'Tart cranberry, warm cinnamon, slow-brewed coffee.',                                        price: '₹360', image: '/images/flagship/cranberry-cinnamon-cold-brew.jpg' },
      { name: 'Cold Brew Cloud',                description: 'Cold brew float topped with a thick salted cream cap.',                                      price: '₹320', image: '/images/flagship/cold-brew-cloud.jpg' },
    ],
  },
  {
    id: 'lattes',
    ...
    items: [
      ...
      { name: 'Ube Cloud',            description: 'Ube taro latte, ube cream swirl, butterfly pea dust.',                   price: '₹430',        note: 'Signature', image: '/images/flagship/ube-cloud.jpg'                    },
      { name: 'Banana Buzz Latte',    description: 'Caramel milk, espresso, grilled banana skewer.',                         price: '₹390',        note: 'Signature', image: '/images/flagship/banana-buzz-latte.jpg'            },
      { name: 'Strawberry Coffee',    description: 'Strawberry base, espresso, whipped cream.',                              price: '₹380',        note: 'Signature', image: '/images/flagship/strawberry-coffee.jpg'            },
      { name: 'Ube Coffee',           description: 'Ube milk, espresso, caramel pearls.',                                   price: '₹420',        note: 'Signature', image: '/images/flagship/ube-coffee.jpg'                   },
      { name: 'Butterfly Pea Latte',  description: 'Butterfly pea milk, pink base, edible flower.',                         price: '₹390',        note: 'Signature', image: '/images/flagship/butterfly-pea-latte.jpg'          },
    ],
  },
  {
    id: 'frappes',
  ...
  },
  {
    ...
    label: 'Bites & Burgers',
    items: [
      { name: 'Avocado Toast',                    description: '', price: '₹445', note: 'Toast',       image: '/images/flagship/avocado-bloom-toast.jpg'     },
      { name: 'Avocado Bloom Toast',              description: 'Loaded avo, cherry tomatoes, olives, cashews, edible flowers.', price: '₹495', note: 'Toast', image: '/images/flagship/avocado-bloom-toast.jpg' },
      { name: 'Wild Mushroom Crostini',            description: '', price: '₹385', note: 'Toast',       image: '/images/3/Wild Mushroom Crostini.jpg'          },
      { name: 'Chicken Sloppy Toast',              description: 'Pulled chicken, chilli rings, micro greens on sourdough.', price: '₹495', note: 'Toast', image: '/images/flagship/chicken-toast.jpg' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Chipotle Prawns',              description: '',                                                        price: '—',    note: 'Seafood',   image: '/images/flagship/chipotle-prawns.jpg'               },
      { name: 'Prawn Burrito Bowl',           description: '',                                                        price: '—',    note: 'Seafood'                                                                },
      { name: 'BBQ Chicken & Quinoa',         description: 'Smoky BBQ chicken, herbed quinoa, charred broccoli.',   price: '₹545', note: 'Chicken',   image: '/images/flagship/bbq-chicken-quinoa.jpg'            },
    ],
  },
  {
    id: 'wellness',
    ...
    items: [
      { name: 'Acai Power Bowl',     description: 'Acai base, peanut butter, granola, banana, mixed berries, blueberries.',      price: '₹490', image: '/images/flagship/acai-bowl.jpg'         },
      { name: 'Coconut Granola Bowl',description: 'Coconut base, banana, coconut pieces, granola, chia seeds, edible flower.',  price: '₹450', image: '/images/flagship/coconut-bowl.jpg'      },
      { name: 'Green Detox Bowl',    description: 'Matcha-kiwi base, dragon fruit, pineapple, kiwi, edible flower.',            price: '₹490', image: '/images/flagship/green-bowl.jpg'        },
    ],
  },
  {
    id: 'breakfast',
